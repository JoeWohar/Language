...
<div id="container">
	<div id="header">
		User Task Form: CustomerOnBoard.AddAddress
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Info</legend>
            	...
            	<div class="div_checkbox"><![CDATA[task-group]]></div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="Customer" type="text" class="textbox" id="Customer" value="${Customer}" />
                            		</div>
